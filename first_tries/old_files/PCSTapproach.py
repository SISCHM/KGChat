...
edges_df = pd.read_csv("edges1.tsv", delimiter=';')
...
print("Hier die teile",node_features,edge_index,edge_attr)
print("Hier der Graph:",graph)
'''''
G = nx.DiGraph()
...
print("Hier die Parts:",graph, q_emb, textual_nodes, textual_edges)
# RETRIEVAL
